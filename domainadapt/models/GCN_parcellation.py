...
class GCN(nn.Module):
    def __init__(self, feat, hid, par, emb_size, ker_size):
        ...
        hid2 = torch.div(hid, 4).item()
        self.gc3_1 = GraphConvolution(feat + hid + hid1, hid2, emb_size, ker_size)
        self.gc3_2 = nn.LeakyReLU(0.01)

        self.gc4_1 = GraphConvolution(feat + hid + hid1 + hid2, par, emb_size, ker_size)
